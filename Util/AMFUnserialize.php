...
class FLV_Util_AMFUnserialize
{
     ...
     * @return int position from the start of the stream or false on failure
     */
     ...
     * @access private
     */
    public function getSizedString($size)
    {
        if ($size > 0) {
     ...
     * Unserializes a date
     *
     * @return string a string with the date in ISO 8601 format
     */
